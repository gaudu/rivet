...
namespace Rivet {
  ...
  class E104_1979_I132765 : public Analysis {
  public:

    /// Constructor
    RIVET_DEFAULT_ANALYSIS_CTOR(E104_1979_I132765);
    ...
    void init() {
      ...
      _plab_edges = {200, 240, 280, 310, 340, 370};
  ...
  RIVET_DECLARE_PLUGIN(E104_1979_I132765);
